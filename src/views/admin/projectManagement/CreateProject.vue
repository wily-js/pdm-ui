    ...
    <div class="cpj-body">
        <el-form ref="ruleForm" :model="form" :rules="rules" label-width="120px">
            ...
            <el-form-item label="项目负责人：" prop="manager">
                <el-select v-model="form.manager" :loading="loading" filterable remote :reserve-keyword="false"
                    default-first-option remote-show-suffix :remote-method="remoteMethod" placeholder="请选择项目负责人"
                    value-key="name">
